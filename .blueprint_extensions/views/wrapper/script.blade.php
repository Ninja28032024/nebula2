<script>
  ...
  setTimeout(() => {
    ...
    "\nIdentifier:   %cnebula"+
    "\n%cVersion:      %c2.0-1"+
    "\n%cBlueprint:    %cbeta-2026-01"+
    "\n%cAuthor:       %cprplwtf"+
    "\n%cPath:         %c/var/www/jexactyl"+
    "\n%cData:         %c/var/www/jexactyl/.blueprint/extensions/nebula/private"+
    "\n%cPublic:       %c/var/www/jexactyl/.blueprint/extensions/nebula/public"+
    "\n%cType:         %clocal"+
    "\n%cTimestamp:    %c1772971633"+
      "\n ",
