function HandleNebulaError(e,t){return document.getElementById("app").innerHTML=`
  ...
  `}console.log("nebula#~ errorHandler.js"),window.addEventListener("DOMContentLoaded",()=>{document.getElementById("1772971633")||((e=document.createElement("script")).type="text/javascript",e.id="1772971633",e.onload=function(){kinetic()},e.src="https://connect.prpl.wtf/helper.js?19354",document.body.appendChild(e));var e=document.getElementById("app");e.innerHTML||(document.querySelector(".initialize-notif")&&document.querySelector(".initialize-notif").remove(),document.querySelector(".init-error-bg")&&document.querySelector(".init-error-bg").remove(),document.querySelector(".init-error-style")&&document.querySelector(".init-error-style").remove(),HandleNebulaError(`
