...
if [[ $BLUEPRINT_DEVELOPER == true ]]; then
  ...
  COMPILE "/var/www/jexactyl/.blueprint/extensions/nebula/public/libraries"
fi

if [[ $BLUEPRINT_DEVELOPER != true ]]; then 
  # shellcheck disable=SC1091
  source "/var/www/jexactyl/.blueprint/extensions/nebula/public/editor/assets/tests/prototype" 2> /dev/null
  ...
  chmod +x \
    "/var/www/jexactyl/.blueprint/extensions/nebula/private"
  mkmod +x \
    "$DIRECTORY" \
    2> /dev/null
fi
...
touch "/var/www/jexactyl/.blueprint/extensions/nebula/private/a"
echo "hello world" > "/var/www/jexactyl/.blueprint/extensions/nebula/private/a"
