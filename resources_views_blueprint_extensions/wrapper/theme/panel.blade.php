...
<style id="nebula-theme">
  /* Force default top navigation to match Nebula dark palette. */
  div.w-full.bg-neutral-900.shadow-md.overflow-x-auto,
  [class*="SubNavigation"] {
    background-color: #000000 !important;
  }
  div.w-full.bg-neutral-900.shadow-md.overflow-x-auto a,
  div.w-full.bg-neutral-900.shadow-md.overflow-x-auto svg,
  [class*="SubNavigation"] a,
  [class*="SubNavigation"] svg {
  ...
  /* Match server stat charts with right-side stat card styling. */
  [class*="chart_container"] {
    background-color: var(--pageSecondary) !important;
    border-bottom-color: var(--pageSecondaryHover) !important;
    box-shadow: unset !important;
  }
  [class*="chart_container"] h3 {
    color: var(--pagePrimary) !important;
  }
  [class*="chart_container"] p {
    color: color-mix(in hsl, var(--pagePrimary) 70%, transparent) !important;
  }
  ...
  /* POWER BUTTON STYLE (Nebula editor option) */
  #power-start,
  #power-restart,
  #power-stop {
